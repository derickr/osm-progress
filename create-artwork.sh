...
convert /tmp/temp-end.jpg \
	-gravity southwest -stroke none -fill white -font "FreeSerif-Bold" -pointsize 28 -annotate +20+50 "data:" \
	-gravity southwest -stroke none -fill white -font "FreeSerif-Bold" -pointsize 28 -annotate +20+20 "visuals:" \
	-gravity southwest -stroke none -fill white -font "FreeSerif-Medium" -pointsize 28 -annotate +120+50 "OpenStreetMap (http://openstreetmap.org) and contributors (cc-by-sa)" \
	-gravity southwest -stroke none -fill white -font "FreeSerif-Medium" -pointsize 28 -annotate +120+20 "Derick Rethans (http://derickrethans.nl) (cc-by-nc-sa)" \
	artwork/end.jpg
