...
convert /tmp/temp-end.jpg \
	...
	-gravity southwest -stroke none -fill white -font "FreeSerif-Medium" -pointsize 28 -annotate +170+110 "OpenStreetMap (http://openstreetmap.org) and contributors (cc-by-sa)" \
