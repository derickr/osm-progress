...
#wget http://download.geofabrik.de/openstreetmap/europe/great-britain-latest.osm.pbf -O great-britain.osm.pbf
...
# get state file from http://planet.openstreetmap.org/replication-minute
